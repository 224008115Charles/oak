package cn.zhangxd.oak.gateway.security.oauth2;

import cn.zhangxd.oak.core.config.OakProperties;
import cn.zhangxd.oak.gateway.config.oauth2.OAuth2Properties;
...
public abstract class OAuth2TokenEndpointClientAdapter implements OAuth2TokenEndpointClient {
    ...
    protected final OakProperties oakProperties;
    protected final OAuth2Properties oAuth2Properties;

    public OAuth2TokenEndpointClientAdapter(RestTemplate restTemplate, OakProperties oakProperties, OAuth2Properties oAuth2Properties) {
    ...
    protected String getTokenEndpoint() {
        String tokenEndpointUrl = oakProperties.getSecurity().getClientAuthorization().getAccessTokenUri();
