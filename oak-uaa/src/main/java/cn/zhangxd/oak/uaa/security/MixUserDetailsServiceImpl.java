...
public class MixUserDetailsServiceImpl implements UserDetailsService {

    private final Logger log = LoggerFactory.getLogger(MixUserDetailsServiceImpl.class);

    private final SysUserService userService;

    public MixUserDetailsServiceImpl(SysUserService userService) {
